...
<style>
/* Enhanced styling for wallet management page with dark mode support */
.table-responsive {
    border-radius: 8px;
}
...
.form-select:focus, .form-control:focus {
    ...
    box-shadow: 0 0 0 0.2rem rgba(var(--cui-primary-rgb), 0.1);
}
...
/* Transaction amount styling - keep these specific colors */
.text-success {
...
[data-coreui-theme="dark"] .btn-outline-success:hover,
[data-coreui-theme="dark"] .btn-outline-warning:hover,
[data-coreui-theme="dark"] .btn-outline-danger:hover {
...
[data-coreui-theme="dark"] .card-body.border-bottom {
    background-color: var(--cui-dark-bg-subtle);
}
