...
<style>
/* Dark Mode Support for Admin Logs Page */
...
/* Log level background overrides for dark mode */
[data-coreui-theme="dark"] .list-group-item.bg-danger-subtle {
    background-color: rgba(var(--cui-danger-rgb), 0.1) !important;
    border-color: rgba(var(--cui-danger-rgb), 0.2);
}

[data-coreui-theme="dark"] .list-group-item.bg-warning-subtle {
    background-color: rgba(var(--cui-warning-rgb), 0.1) !important;
    border-color: rgba(var(--cui-warning-rgb), 0.2);
}
...
/* Form label colors in dark mode */
[data-coreui-theme="dark"] .form-label {
    color: var(--cui-body-color);
}

/* Small text and timestamps */
[data-coreui-theme="dark"] .small {
    color: var(--cui-secondary-color);
}

/* Fix for dynamic modal content */
[data-coreui-theme="dark"] .modal .text-body-secondary {
    color: var(--cui-secondary-color) !important;
}

[data-coreui-theme="dark"] .modal .fw-semibold {
    color: var(--cui-body-color) !important;
}

/* List group flush borders */
[data-coreui-theme="dark"] .list-group-flush .list-group-item {
    border-left: 0;
    border-right: 0;
}

[data-coreui-theme="dark"] .list-group-flush .list-group-item:first-child {
    border-top: 0;
}

[data-coreui-theme="dark"] .list-group-flush .list-group-item:last-child {
    border-bottom: 0;
}

/* Empty state styling */
[data-coreui-theme="dark"] .card-body.text-center .icon {
    color: var(--cui-secondary-color);
}
