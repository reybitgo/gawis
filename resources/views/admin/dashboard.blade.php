...
[data-coreui-theme="dark"] .quick-action-card:hover {
...
/* Recent System Activity - Transaction items */
.transaction-item {
...
/* Dark mode specific transaction item styling */
[data-coreui-theme="dark"] .transaction-item .fw-semibold {
    color: var(--cui-body-color) !important;
}

[data-coreui-theme="dark"] .transaction-item .text-muted {
...
/* Dark mode card background fixes */
[data-coreui-theme="dark"] .card {
    background-color: var(--cui-card-bg);
    border-color: var(--cui-border-color);
}

[data-coreui-theme="dark"] .quick-action-card {
    background-color: var(--cui-card-bg);
    border-color: var(--cui-border-color);
}
...
/* Recent Activity header dark mode fix */
