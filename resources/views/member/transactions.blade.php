...
<div class="card shadow-sm mb-5">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small class="text-body-secondary">Manage and review all your e-wallet transactions</small>
                </div>
            </div>
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <label for="per_page" class="form-label mb-0 small text-body-secondary">Show:</label>
            ...
            <tbody>
                ...
                <tr class="border-bottom">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if($transaction->description)
                                    <div class="small text-body-secondary">{{ Str::limit($transaction->description, 40) }}</div>
                                @endif
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <div class="small text-body-secondary">{{ $transaction->created_at->format('g:i A') }}</div>
                    </td>
                    <td class="px-4 py-3">
                        @if($transaction->reference_number)
                            <div class="font-monospace small bg-secondary-subtle px-2 py-1 rounded border">
    ...
    <div class="card-body">
        <div class="text-center py-5">
            <div class="bg-secondary-subtle rounded-circle mx-auto mb-4 d-flex align-items-center justify-content-center" style="width: 80px; height: 80px;">
                <svg class="icon icon-3xl text-body-secondary">
                    <use xlink:href="{{ asset('coreui-template/vendors/@coreui/icons/svg/free.svg#cil-list') }}"></use>
                </svg>
            </div>
            <h5 class="text-body-secondary mb-3">No transactions yet</h5>
            <p class="text-body-secondary mb-4">Your transaction history will appear here once you start using your e-wallet.</p>
...
/* Subtle backgrounds for light mode */
.bg-success-subtle {
...
/* Dark mode overrides for subtle backgrounds */
...
[data-coreui-theme="dark"] .bg-warning-subtle {
    background-color: rgba(var(--cui-warning-rgb), 0.15) !important;
}
...
[data-coreui-theme="dark"] .bg-secondary-subtle {
    background-color: rgba(var(--cui-secondary-rgb), 0.15) !important;
}
...
/* Empty state styling */
[data-coreui-theme="dark"] .card-body .bg-secondary-subtle {
